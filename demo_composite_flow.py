...
def continuous_conveyor(env, length, speed, dt, input_store, spacing, out_store, exit_times=None):
    items = []
    while True:
...
def demo_composite_flow(
    ...
    p_buffer = Conveyor(env, "P_buffer", conveyor_speed=1, init_load=0, max_load=10000)
