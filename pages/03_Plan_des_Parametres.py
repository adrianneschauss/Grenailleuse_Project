      ...
      function showParams(key) {{
        ...
        if (key === 'arrivee') {{
          ...
          box.innerHTML = `
            ...
            Le changement se fait par petites étapes, avec un minimum (0,5x la vitesse normale) et un maximum (2x la vitesse normale), pour rester stable.<br/>
            Objectif : bloquer la grenailleuse le moins possible en ajustant la vitesse pour qu’elle soit mieux alignée avec celle de l’inspecteur.<br/></i>
            
          `;
        }} else if (key === 'dechargement') {{
          box.innerHTML = `
            <b><u>Déchargement vers convoyeur (s)</u></b><br/>
            <b>Délai:</b> entre sortie grenailleuse et entrée convoyeur.
          `;
        }} else if (key === 'tampon') {{
          box.innerHTML = `
            <b><u>Tampon</u></b><br/>
            <b>Espacement vertical (cm):</b> espace requis pour une bouteille verticale sur le tampon (> diamètre de la bouteille).<br/>
            <b>Longueur convoyeur 1 (cm):</b> longueur totale du tampon.
          `;
        }} else if (key === 'variable_conv') {{
          box.innerHTML = `
            <b><u>Convoyeur variable</u></b><br/>
            <b>Espacement horizontal (cm):</b> espace requis pour une bouteille horizontale sur le convoyeur (> longueur de la bouteille).<br/>
            <b>Vitesse convoyeur variable (cm/s):</b> vitesse du convoyeur en continu.<br/>
            <b>Temps de pas variable (s):</b> temps pour faire un pas (distance par pas équivalente à une longueur de bouteille).<br/>
            <b>Délai changement mode (s):</b> temps minimum entre un passage du pas-à-pas au continu et vice-versa.
            <br/><br/>
            <i><b><u>Changement pas-à-pas / continu (détails)</u></b><br/>
            Le mode pas-à-pas est activé lorsque d1 et d2 sont actifs simultanément pendant au moins le temps de déclenchement des détecteurs.<br/>
            Le mode continu est réactivé lorsque d1 et d2 ne sont plus actifs ensemble (par exemple d2=0 avec d1=1, ou d1=0 et d2=0), tant que d3 et d4 ne sont pas actifs.<br/>
            Objectif: remplir le convoyeur en pas-à-pas quand l’aval est chargé, puis repasser en continu pour alimenter l’inspecteur dès que l’aval se libère.<br/></i>
          `;
        }} else if (key === 'longueur_convoyeur_1') {{
          box.innerHTML = `
            <b><u>Longueur convoyeur 1 (cm)</u></b>
          `;
        }} else if (key === 'det_hold_time') {{
          box.innerHTML = `
            <b><u>Temps déclenchement détecteurs (s)</u></b><br/>
            <b>Description:</b> temps entre la détection d'une bouteille et la persistance du signal pour déclencher le détecteur.
          `;
        }} else if (key === 'conv_continu') {{
          box.innerHTML = `
            <b><u>Convoyeur horizontal continu</u></b><br/>
            <b>Longueur convoyeur continu (cm):</b> longueur totale du convoyeur continu.<br/>
            <b>Vitesse convoyeur continu (cm/s):</b> vitesse du convoyeur continu.
          `;
